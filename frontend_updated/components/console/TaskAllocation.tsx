...
export default function TaskAllocation() {
  ...
  const loadTasks = async () => {
    ...
    try {
      console.log('Loading system tasks...');
      const result = await API.tasks.getSystemTasks(
        orgFilter === 'all' ? undefined : undefined, // TODO: Map org filter
        statusFilter === 'all' ? undefined : statusFilter
      );
      
      console.log('System tasks loaded:', result);
      ...
      const transformedTasks = result.tasks.map((task: any) => ({
        ...
        tableBbox: task.table_bbox,
        tableRows: task.table_rows,
        tableCols: task.table_cols,
        ...
        createdAt: task.created_at.split('T')[0], // Format date
        dueDate: task.due_date.split('T')[0], // Format date
        requiredSkills: task.required_skills || [],
        aiDraftStatus: task.ai_draft_status || 'not_generated',
        aiDraftGenerationLog: [],
        hasFootnotes: task.has_footnotes || false,
        pdfGroup: task.pdf_group || task.file_name
      }));
        ...
        <div className="space-y-6">
          ...
          {isLoadingTasks && (
            <div className="bg-white rounded-lg shadow-sm p-8 text-center">
              ...
              <p className="text-gray-600">Fetching task data from backend</p>
            </div>
          )}
          ...
          {tasksError && (
            <div className="bg-white rounded-lg shadow-sm p-8 text-center">
              <i className="ri-error-warning-line w-12 h-12 flex items-center justify-center text-red-500 mx-auto mb-4"></i>
